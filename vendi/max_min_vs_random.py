...
num_picks_range = list(range(2, 185))   # From 2 to 92 and 184
...
results_df.to_csv("vendi/max_min_vs_random/max_min_vs_random_results.csv", index=False)  # Save the averages to CSV
