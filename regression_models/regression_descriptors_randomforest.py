...
descriptors_all = pd.read_csv("source_data/dataset_descriptors.csv", header=None)
...
if PERFORM_GRID_SEARCH:
    ...
    np.save("regression_outputs/regression_descriptors_randomforest/PCC_grid_n_estimators_max_depth.npy", PCC_grid)
    np.save("regression_outputs/regression_descriptors_randomforest/MSE_grid_n_estimators_max_depth.npy", MSE_grid)

PCC_grid_n_estimators_max_depth = np.load("regression_outputs/regression_descriptors_randomforest/PCC_grid_n_estimators_max_depth.npy")
MSE_grid_n_estimators_max_depth = np.load("regression_outputs/regression_descriptors_randomforest/MSE_grid_n_estimators_max_depth.npy")
...
if PERFORM_GRID_SEARCH:
    ...
    np.save("regression_outputs/regression_descriptors_randomforest/PCC_grid_min_samples_split_min_samples_leaf.npy", PCC_grid)
    np.save("regression_outputs/regression_descriptors_randomforest/MSE_grid_min_samples_split_min_samples_leaf.npy", MSE_grid)

PCC_grid_min_samples_split_min_samples_leaf = np.load("regression_outputs/regression_descriptors_randomforest/PCC_grid_min_samples_split_min_samples_leaf.npy")
MSE_grid_min_samples_split_min_samples_leaf = np.load("regression_outputs/regression_descriptors_randomforest/MSE_grid_min_samples_split_min_samples_leaf.npy")
...
np.save("regression_outputs/regression_descriptors_randomforest/feature_importances.npy", feature_importances)
np.save("regression_outputs/regression_descriptors_randomforest/predicted_data_means.npy", predicted_data_means)
np.save("regression_outputs/regression_descriptors_randomforest/predicted_data_stds.npy", predicted_data_stds)
np.save("regression_outputs/regression_descriptors_randomforest/MSE.npy", MSE)
np.save("regression_outputs/regression_descriptors_randomforest/PCC.npy", PCC)

feature_importances = np.load("regression_outputs/regression_descriptors_randomforest/feature_importances.npy")
predicted_data_means = np.load("regression_outputs/regression_descriptors_randomforest/predicted_data_means.npy")
predicted_data_stds = np.load("regression_outputs/regression_descriptors_randomforest/predicted_data_stds.npy")
MSE = np.load("regression_outputs/regression_descriptors_randomforest/MSE.npy")
PCC = np.load("regression_outputs/regression_descriptors_randomforest/PCC.npy")
