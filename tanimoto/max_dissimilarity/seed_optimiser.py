...
# Step 2: Iterate through 500,000 random seeds with progress tracking
for iteration in tqdm(range(500000), desc="Processing seeds", unit="seed"):
    ...
    avg_similarity = calculate_average_similarity(clusters, similarity_matrix)
...
top_seeds_df.to_csv('top_100_seeds.csv', index=False)

print("Top 100 seeds and their average similarities saved to 'top_100_seeds.csv'.")