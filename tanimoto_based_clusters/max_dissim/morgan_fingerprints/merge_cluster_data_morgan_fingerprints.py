...
seed_affinity = pd.read_csv('../tanimoto_based_clusters/max_dissim/n_clusters/9_clusters/clusters_9_seed_101855_affinity.csv')
...
final_output_file = '../tanimoto_based_clusters/max_dissim/morgan_fingerprints/final_merged_data_with_fingerprints_9_clusters_max_dissim.csv'
