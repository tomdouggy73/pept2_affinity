...
output_df.to_csv('../tanimoto_based_clusters/max_dissim/n_clusters/3_clusters/clusters_3_seed_760.csv', index=False)

print("Cluster assignments saved to 'clusters_seed_760.csv'.")

# Step 5: Load the affinity data from dataset_smiles.csv
affinity_file_path = '../source_data/dataset_smiles.csv'  # Replace with your actual file path
...
output_file_path = '../tanimoto_based_clusters/max_dissim/n_clusters/3_clusters/clusters_3_seed_760_affinity.csv'  # Replace with your desired output path
